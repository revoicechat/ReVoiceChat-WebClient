...
customElements.define('revoice-icon-circle-check', CircleCheckIconComponent);
...
customElements.define('revoice-icon-appearance', AppearanceIconComponent);
customElements.define('revoice-icon-arrow-out', ArrowPointingOut);
customElements.define('revoice-icon-telescope', Telescope);
customElements.define('revoice-icon-square-plus', SquarePlus);